...
#ifdef __ANDROID__
    struct ANativeWindow *nativeWindow = (struct ANativeWindow *)(uintptr_t)drawable;
    eglSurf = context->eglSurface = egl_eglCreateWindowSurface(eglDisplay, context->eglConfigs[0], nativeWindow, attrib_list);
#else
